        ...
        "messages" : [
            {
                ...
                "content" :[
                    {
                        "type": "text", 
                        "text": """You are an expert AI trained in recognizing professional cricket players with high accuracy.
                                Carefully analyze the given image and identify the player with certainity.
